// Change this pass to whatever you want!
...
void main()
{
	...
	vec2 st = frag_coord.xy / resolution.xy;
	...
	frag_color = vec4(top_red*float(row1)   + mid_red*float(row2 && !row1) + bottom_red*float(!row2), 
